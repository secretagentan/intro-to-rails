...
class LettersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create letter" do
    assert_difference('Letter.count') do
      post letters_url, params: { letter: { from_address: @letter.from_address, is_read: @letter.is_read, message: @letter.message, to_address: @letter.to_address } }, as: :json
    end
  ...
  test "should update letter" do
    patch letter_url(@letter), params: { letter: { from_address: @letter.from_address, is_read: @letter.is_read, message: @letter.message, to_address: @letter.to_address } }, as: :json
    assert_response 200
  end
